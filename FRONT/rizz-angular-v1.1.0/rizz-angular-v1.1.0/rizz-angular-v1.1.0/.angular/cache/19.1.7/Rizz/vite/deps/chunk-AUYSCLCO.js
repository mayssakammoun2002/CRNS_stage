    ...
    !function(t, e) {
      ...
      return function(t) {
        ...
        return r.m = t, r.c = e, r.d = function(t2, e2, i) {
          r.o(t2, e2) || Object.defineProperty(t2, e2, {
            enumerable: true,
            get: i
          });
        }, r.r = function(t2) {
          ...
          if (r.r(i), Object.defineProperty(i, "default", {
            enumerable: true,
            value: t2
          }), 2 & e2 && "string" != typeof t2) for (var n in t2) r.d(i, n, function(e3) {
            return t2[e3];
          }.bind(null, n));
          return i;
        }, r.n = function(t2) {
        ...
        i = [r(2)], void 0 === (n = function(t2) {
          function e2(i3) {
            if (e2.is(i3, "function")) return r2 ? i3() : t2.on("raphael.DOMload", i3);
            if (e2.is(i3, A)) return e2._engine.create[c](e2, i3.splice(0, 3 + e2.is(i3[0], T))).add(i3);
          ...
          var r2, i2, n2 = /[, ]+/, a = {
            ...
            mousemove: "touchmove",
            mouseup: "touchend"
          }, b = x.prototype.toLowerCase, _ = Math, w = _.max, k = _.min, B = _.abs, C = _.pow, S = _.PI, T = "number", A = "array", M = Object.prototype.toString, E = (e2._ISURL = /^url\(['"]?(.+?)['"]?\)$/i, /^\s*((#[a-f\d]{6})|(#[a-f\d]{3})|rgba?\(\s*([\d\.]+%?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+%?(?:\s*,\s*[\d\.]+%?)?)\s*\)|hsba?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\)|hsla?\(\s*([\d\.]+(?:deg|\xb0|%)?\s*,\s*[\d\.]+%?\s*,\s*[\d\.]+(?:%?\s*,\s*[\d\.]+)?)%?\s*\))\s*$/i), N = {
            NaN: 1,
            Infinity: 1,
            "-Infinity": 1
          }, L = /^(?:cubic-)?bezier\(([^,]+),([^,]+),([^,]+),([^\)]+)\)/, P = _.round, z = parseFloat, F = parseInt, R = x.prototype.toUpperCase, j = e2._availableAttrs = {
            "arrow-end": "none",
            "arrow-start": "none",
            blur: 0,
            ...
            hs: 1,
            rg: 1
          }, O = /,?([achlmqrstvxz]),?/gi, V = /([achlmrqstvz])[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*)+)/gi, W = /([rstm])[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029,]*((-?\d*\.?\d*(?:e[\-+]?\d+)?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*)+)/gi, Y = /(-?\d*\.?\d*(?:e[\-+]?\d+)?)[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,?[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*/gi, G = (e2._radial_gradient = /^r(?:\(([^,]+?)[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*,[\x09\x0a\x0b\x0c\x0d\x20\xa0\u1680\u180e\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u202f\u205f\u3000\u2028\u2029]*([^\)]+?)\))?/, {}), H = function(t3, e3) {
            return z(t3) - z(e3);
          }, X = function(t3) {
            return t3;
            ...
            for (n3 = 0, s2 = (t3 = Tt(t3)).length; n3 < s2; n3++) for (a2 = 1, o2 = (l2 = t3[n3]).length; a2 < o2; a2 += 2) r3 = e3.x(l2[a2], l2[a2 + 1]), i3 = e3.y(l2[a2], l2[a2 + 1]), l2[a2] = r3, l2[a2 + 1] = i3;
            return t3;
          };
          if (e2._g = l, e2.type = l.win.SVGAngle || l.doc.implementation.hasFeature("http://www.w3.org/TR/SVG11/feature#BasicStructure", "1.1") ? "SVG" : "VML", "VML" == e2.type) {
            ...
            if (K.innerHTML = '<v:shape adj="1"/>', (J = K.firstChild).style.behavior = "url(#default#VML)", !J || "object" != typeof J.adj) return e2.type = d;
            K = null;
          }
          function tt(t3) {
            if ("function" == typeof t3 || Object(t3) !== t3) return t3;
            var e3 = new t3.constructor();
            for (var r3 in t3) t3[o](r3) && (e3[r3] = tt(t3[r3]));
            return e3;
          }
          e2.svg = !(e2.vml = "VML" == e2.type), e2._Paper = u, e2.fn = i2 = u.prototype = e2.prototype, e2._id = 0, e2.is = function(t3, e3) {
            ...
            if (i3 = e2.is(i3, "finite") ? i3 : 10, e2.is(t3, A)) {
              for (var n3 = t3.length; n3--; ) if (B(t3[n3] - r3) <= i3) return t3[n3];
            } else {
              var a2 = r3 % (t3 = +t3);
          ...
          function ht(t3, e3, r3) {
            return function i3() {
              ...
              return s2[o](a2) ? (function(t4, e4) {
                for (var r4 = 0, i4 = t4.length; r4 < i4; r4++) if (t4[r4] === e4) return t4.push(t4.splice(r4, 1)[0]);
          ...
          e2.color = function(t3) {
            ...
            return e2.is(t3, "object") && "h" in t3 && "s" in t3 && "b" in t3 ? (r3 = e2.hsb2rgb(t3), t3.r = r3.r, t3.g = r3.g, t3.b = r3.b, t3.hex = r3.hex) : e2.is(t3, "object") && "h" in t3 && "s" in t3 && "l" in t3 ? (r3 = e2.hsl2rgb(t3), t3.r = r3.r, t3.g = r3.g, t3.b = r3.b, t3.hex = r3.hex) : (e2.is(t3, "string") && (t3 = e2.getRGB(t3)), e2.is(t3, "object") && "r" in t3 && "g" in t3 && "b" in t3 ? (r3 = e2.rgb2hsl(t3), t3.h = r3.h, t3.s = r3.s, t3.l = r3.l, r3 = e2.rgb2hsb(t3), t3.v = r3.b) : (t3 = {
              hex: "none"
            }).r = t3.g = t3.b = t3.h = t3.s = t3.v = t3.l = -1), t3.toString = st, t3;
            ...
            var i3, n3;
            return t3 = (r3 = ot(t3, e3, r3))[0], e3 = r3[1], r3 = r3[2], {
              h: ((0 == (n3 = (i3 = w(t3, e3, r3)) - k(t3, e3, r3)) ? null : i3 == t3 ? (e3 - r3) / n3 : i3 == e3 ? (r3 - t3) / n3 + 2 : (t3 - e3) / n3 + 4) + 360) % 6 * 60 / 360,
              s: 0 == n3 ? 0 : n3 / i3,
              b: i3,
              toString: nt
            };
            ...
            var i3, n3, a2, s2;
            return t3 = (r3 = ot(t3, e3, r3))[0], e3 = r3[1], r3 = r3[2], i3 = ((n3 = w(t3, e3, r3)) + (a2 = k(t3, e3, r3))) / 2, {
              h: ((0 == (s2 = n3 - a2) ? null : n3 == t3 ? (e3 - r3) / s2 : n3 == e3 ? (r3 - t3) / s2 + 2 : (t3 - e3) / s2 + 4) + 360) % 6 * 60 / 360,
              s: 0 == s2 ? 0 : i3 < 0.5 ? s2 / (2 * i3) : s2 / (2 - 2 * i3),
              l: i3,
              toString: at
            };
          ...
          e2.getRGB = ht(function(t3) {
            if (!t3 || (t3 = x(t3)).indexOf("-") + 1) return {
              r: -1,
              g: -1,
              b: -1,
              hex: "none",
            ...
            return e2.is(t3, A) && e2.is(t3[0], A) && (n3 = mt(t3)), n3.length || x(t3).replace(V, function(t4, e3, r4) {
              ...
              if (r4.replace(Y, function(t5, e4) {
                e4 && a2.push(+e4);
              }), "m" == s2 && a2.length > 2 && (n3.push([e3][f](a2.splice(0, 2))), s2 = "l", e3 = "m" == e3 ? "l" : "L"), "r" == s2) n3.push([e3][f](a2));
              else for (; a2.length >= i3[s2] && (n3.push([e3][f](a2.splice(0, i3[s2]))), i3[s2]); ) ;
            ...
            for (var e3 = [], r3 = 0; r3 < t3.length; r3++) {
              for (var i3 = [], n3 = 0; n3 < t3[r3].length; n3++) i3.push(t3[r3][n3]);
              e3.push(i3);
            }
            return e3;
          });
          var ft = function(t3) {
            ...
            return e3[t3] ? e3[t3].sleep = 100 : e3[t3] = {
              ...
              for (var r3 in e3) e3[o](r3) && r3 != t3 && (e3[r3].sleep--, !e3[r3].sleep && delete e3[r3]);
            }), e3[t3];
          };
          ...
          function gt(t3, e3, r3, i3, n3, a2, s2, o2) {
            if (!(w(t3, r3) < k(n3, s2) || k(t3, r3) > w(n3, s2) || w(e3, i3) < k(a2, o2) || k(e3, i3) > w(a2, o2))) {
              ...
              if (l2) {
                ...
                if (!(c2 < +k(t3, r3).toFixed(2) || c2 > +w(t3, r3).toFixed(2) || c2 < +k(n3, s2).toFixed(2) || c2 > +w(n3, s2).toFixed(2) || f2 < +k(e3, i3).toFixed(2) || f2 > +w(e3, i3).toFixed(2) || f2 < +k(a2, o2).toFixed(2) || f2 > +w(a2, o2).toFixed(2))) return {
                  x: h2,
                  y: u2
                };
              }
          ...
          function xt(t3, r3, i3) {
            ...
            for (d2 = 0; d2 < h2 + 1; d2++) g2 = e2.findDotsAtSegment.apply(e2, r3.concat(d2 / h2)), c2.push({
              x: g2.x,
              y: g2.y,
              t: d2 / h2
            });
            for (d2 = 0; d2 < l2; d2++) for (var x2 = 0; x2 < h2; x2++) {
              ...
              if (S2) {
                if (f2[S2.x.toFixed(4)] == S2.y.toFixed(4)) continue;
                ...
                T2 >= 0 && T2 <= 1.001 && A2 >= 0 && A2 <= 1.001 && (i3 ? p2++ : p2.push({
                  x: S2.x,
                  y: S2.y,
                  t1: k(T2, 1),
                  t2: k(A2, 1)
          ...
          function vt(t3, r3, i3) {
            ...
            for (var n3, a2, s2, o2, l2, h2, u2, c2, f2, p2, d2 = i3 ? 0 : [], g2 = 0, x2 = t3.length; g2 < x2; g2++) {
              var v2 = t3[g2];
              if ("M" == v2[0]) n3 = l2 = v2[1], a2 = h2 = v2[2];
              else {
                ...
                for (var y2 = 0, m2 = r3.length; y2 < m2; y2++) {
                  var b2 = r3[y2];
                  if ("M" == b2[0]) s2 = u2 = b2[1], o2 = c2 = b2[2];
                  else {
                    "C" == b2[0] ? (p2 = [s2, o2].concat(b2.slice(1)), s2 = p2[6], o2 = p2[7]) : (p2 = [s2, o2, s2, o2, u2, c2, u2, c2], s2 = u2, o2 = c2);
                    var _2 = xt(f2, p2, i3);
                    if (i3) d2 += _2;
                    else {
                      for (var w2 = 0, k2 = _2.length; w2 < k2; w2++) _2[w2].segment1 = g2, _2[w2].segment2 = y2, _2[w2].bez1 = f2, _2[w2].bez2 = p2;
                      d2 = d2.concat(_2);
                    }
                  }
                }
          ...
          var yt = e2.pathBBox = function(t3) {
            ...
            for (var r3, i3 = 0, n3 = 0, a2 = [], s2 = [], o2 = 0, l2 = (t3 = Tt(t3)).length; o2 < l2; o2++) if ("M" == (r3 = t3[o2])[0]) i3 = r3[1], n3 = r3[2], a2.push(i3), s2.push(n3);
            else {
              var h2 = St(i3, n3, r3[1], r3[2], r3[3], r3[4], r3[5], r3[6]);
              a2 = a2[f](h2.min.x, h2.max.x), s2 = s2[f](h2.min.y, h2.max.y), i3 = r3[5], n3 = r3[6];
            }
            var u2 = k[c](0, a2), p2 = k[c](0, s2), d2 = w[c](0, a2), g2 = w[c](0, s2), x2 = d2 - u2, v2 = g2 - p2, y2 = {
              x: u2,
              y: p2,
              x2: d2,
              y2: g2,
            ...
            for (var h2 = l2, u2 = t3.length; h2 < u2; h2++) {
              ...
              if (f2[0] != b.call(f2[0])) switch (c2[0] = b.call(f2[0]), c2[0]) {
                case "a":
            ...
            var r3 = ft(t3);
            if (r3.abs) return mt(r3.abs);
            if (e2.is(t3, A) && e2.is(t3 && t3[0], A) || (t3 = e2.parsePathString(t3)), !t3 || !t3.length) return [["M", 0, 0]];
            var i3 = [], n3 = 0, a2 = 0, s2 = 0, o2 = 0, l2 = 0;
            ...
            for (var h2, u2, c2 = 3 == t3.length && "M" == t3[0][0] && "R" == t3[1][0].toUpperCase() && "Z" == t3[2][0].toUpperCase(), p2 = l2, d2 = t3.length; p2 < d2; p2++) {
              if (i3.push(h2 = []), (u2 = t3[p2])[0] != R.call(u2[0])) switch (h2[0] = R.call(u2[0]), h2[0]) {
                case "A":
                ...
                case "H":
                  ...
                  break;
                case "R":
                  for (var g2 = [n3, a2][f](u2.slice(1)), x2 = 2, v2 = g2.length; x2 < v2; x2++) g2[x2] = +g2[x2] + n3, g2[++x2] = +g2[x2] + a2;
                  i3.pop(), i3 = i3[f](ct(g2, c2));
                  break;
                case "M":
                  s2 = +u2[1] + n3, o2 = +u2[2] + a2;
                default:
                  for (x2 = 1, v2 = u2.length; x2 < v2; x2++) h2[x2] = +u2[x2] + (x2 % 2 ? n3 : a2);
              }
              else if ("R" == u2[0]) g2 = [n3, a2][f](u2.slice(1)), i3.pop(), i3 = i3[f](ct(g2, c2)), h2 = ["R"][f](u2.slice(-2));
              else for (var y2 = 0, m2 = u2.length; y2 < m2; y2++) h2[y2] = u2[y2];
              switch (h2[0]) {
                case "Z":
                  n3 = s2, a2 = o2;
                  break;
            ...
            var u2, c2 = 120 * S / 180, p2 = S / 180 * (+n3 || 0), d2 = [], g2 = ht(function(t4, e4, r4) {
              return {
                x: t4 * _.cos(r4) - e4 * _.sin(r4),
                y: t4 * _.sin(r4) + e4 * _.cos(r4)
              };
            });
            if (h2) A2 = h2[0], M2 = h2[1], C2 = h2[2], T2 = h2[3];
            else {
            ...
            if (V2[0] = 2 * O2[0] - V2[0], V2[1] = 2 * O2[1] - V2[1], h2) return [V2, W2, Y2][f](d2);
            for (var G2 = [], H2 = 0, X2 = (d2 = [V2, W2, Y2][f](d2).join()[v](",")).length; H2 < X2; H2++) G2[H2] = H2 % 2 ? g2(d2[H2 - 1], d2[H2], p2).y : g2(d2[H2], d2[H2 + 1], p2).x;
            return G2;
          }, Ct = function(t3, e3, r3, i3, n3, a2, s2, o2, l2) {
            var h2 = 1 - l2;
            return {
              x: C(h2, 3) * t3 + 3 * C(h2, 2) * l2 * r3 + 3 * h2 * l2 * l2 * n3 + C(l2, 3) * s2,
              y: C(h2, 3) * e3 + 3 * C(h2, 2) * l2 * i3 + 3 * h2 * l2 * l2 * a2 + C(l2, 3) * o2
            };
            ...
            return B(p2) > "1e12" && (p2 = 0.5), B(d2) > "1e12" && (d2 = 0.5), p2 > 0 && p2 < 1 && (l2 = Ct(t3, e3, r3, i3, n3, a2, s2, o2, p2), x2.push(l2.x), g2.push(l2.y)), d2 > 0 && d2 < 1 && (l2 = Ct(t3, e3, r3, i3, n3, a2, s2, o2, d2), x2.push(l2.x), g2.push(l2.y)), h2 = a2 - 2 * i3 + e3 - (o2 - 2 * a2 + i3), f2 = e3 - i3, p2 = (-(u2 = 2 * (i3 - e3) - 2 * (a2 - i3)) + _.sqrt(u2 * u2 - 4 * h2 * f2)) / 2 / h2, d2 = (-u2 - _.sqrt(u2 * u2 - 4 * h2 * f2)) / 2 / h2, B(p2) > "1e12" && (p2 = 0.5), B(d2) > "1e12" && (d2 = 0.5), p2 > 0 && p2 < 1 && (l2 = Ct(t3, e3, r3, i3, n3, a2, s2, o2, p2), x2.push(l2.x), g2.push(l2.y)), d2 > 0 && d2 < 1 && (l2 = Ct(t3, e3, r3, i3, n3, a2, s2, o2, d2), x2.push(l2.x), g2.push(l2.y)), {
              min: {
                x: k[c](0, x2),
                y: k[c](0, g2)
              },
            ...
            var r3 = !e3 && ft(t3);
            if (!e3 && r3.curve) return mt(r3.curve);
            for (var i3 = _t(t3), n3 = e3 && _t(e3), a2 = {
              x: 0,
              y: 0,
              bx: 0,
              by: 0,
              ...
              if (t4[e4].length > 7) {
                t4[e4].shift();
                for (var r4 = t4[e4]; r4.length; ) u2[e4] = "A", n3 && (p2[e4] = "A"), t4.splice(e4++, 0, ["C"][f](r4.splice(0, 6)));
            ...
            for (i3 = 1, n3 = r3.length - 1; i3 < n3; i3++) if (!r3[i3].offset) {
              for (var o2 = z(r3[i3 - 1].offset || 0), l2 = 0, h2 = i3 + 1; h2 < n3; h2++) if (r3[h2].offset) {
                l2 = r3[h2].offset;
                break;
              }
              l2 || (l2 = 100, h2 = n3);
              for (var u2 = ((l2 = z(l2)) - o2) / (h2 - i3 + 1); i3 < h2; i3++) o2 += u2, r3[i3].offset = o2 + "%";
            }
            return r3;
            ...
            if (h2.transform = a2 || [], a2) for (var c2 = 0, f2 = a2.length; c2 < f2; c2++) {
            ...
            for (var i3, n3, a2, s2, o2 = w(t3.length, r3.length), l2 = [], h2 = [], u2 = 0; u2 < o2; u2++) {
              if (a2 = t3[u2] || Nt(r3[u2]), s2 = r3[u2] || Nt(a2), a2[0] != s2[0] || "r" == a2[0].toLowerCase() && (a2[2] != s2[2] || a2[3] != s2[3]) || "s" == a2[0].toLowerCase() && (a2[3] != s2[3] || a2[4] != s2[4])) return;
              for (l2[u2] = [], h2[u2] = [], i3 = 0, n3 = w(a2.length, s2.length); i3 < n3; i3++) i3 in a2 && (l2[u2][i3] = a2[i3]), i3 in s2 && (h2[u2][i3] = s2[i3]);
            }
            return {
              from: l2,
              to: h2
          ...
          e2._getContainer = function(t3, r3, i3, n3) {
            var a2;
            if (null != (a2 = null != n3 || e2.is(t3, "object") ? t3 : l.doc.getElementById(t3))) return a2.tagName ? null == r3 ? {
              container: a2,
            ...
            t3.add = function(t4, e3, r4, i4, n3, a2) {
              ...
              for (t4 && t4 instanceof Pt && (f2 = [[t4.a, t4.c, t4.e], [t4.b, t4.d, t4.f], [0, 0, 1]]), s2 = 0; s2 < 3; s2++) for (o2 = 0; o2 < 3; o2++) {
                for (h2 = 0, l2 = 0; l2 < 3; l2++) h2 += c2[s2][l2] * f2[l2][o2];
                u2[s2][o2] = h2;
              }
          ...
          for (var zt = function() {
            ...
            if (t3.addEventListener(e3, n3, false), p && m[e3]) {
              var a2 = function(e4) {
                for (var n4 = It(e4), a3 = e4, s2 = 0, o2 = e4.targetTouches && e4.targetTouches.length; s2 < o2; s2++) if (e4.targetTouches[s2].target == t3) {
            ...
            for (var r3, i3 = e3.clientX, n3 = e3.clientY, a2 = l.doc.documentElement.scrollTop || l.doc.body.scrollTop, s2 = l.doc.documentElement.scrollLeft || l.doc.body.scrollLeft, o2 = qt.length; o2--; ) {
              if (r3 = qt[o2], p && e3.touches) {
                for (var h2, u2 = e3.touches.length; u2--; ) if ((h2 = e3.touches[u2]).identifier == r3.el._drag.id) {
            ...
            for (var i3, n3 = qt.length; n3--; ) (i3 = qt[n3]).el._drag = {}, t2("raphael.drag.end." + i3.el.id, i3.end_scope || i3.start_scope || i3.move_scope || i3.el, r3);
            qt = [];
          }, Wt = e2.el = {}, Yt = y.length; Yt--; ) !function(t3) {
            e2[t3] = Wt[t3] = function(r3, i3) {
              return e2.is(r3, "function") && (this.events = this.events || [], this.events.push({
                name: t3,
                f: r3,
                unbind: Dt(this.shape || this.node || l.doc, t3, r3, i3 || this)
              })), this;
          ...
          Wt.data = function(r3, i3) {
            ...
            if (1 == arguments.length) {
              if (e2.is(r3, "object")) {
                for (var a2 in r3) r3[o](a2) && this.data(a2, r3[a2]);
                return this;
              }
          ...
          Wt.drag = function(r3, i3, n3, a2, s2, o2) {
            function h2(h3) {
              ...
              if (this._drag.id = h3.identifier, p && h3.touches) {
                for (var g2, x2 = h3.touches.length; x2--; ) if (g2 = h3.touches[x2], this._drag.id = g2.identifier, g2.identifier == this._drag.id) {
                  u2 = g2.clientX, c2 = g2.clientY;
                  break;
                }
              }
              this._drag.x = u2 + d2, this._drag.y = c2 + f2, !qt.length && e2.mousemove(Ot).mouseup(Vt), qt.push({
                el: this,
                move_scope: a2,
                start_scope: s2,
                end_scope: o2
              }), i3 && t2.on("raphael.drag.start." + this.id, i3), r3 && t2.on("raphael.drag.move." + this.id, r3), n3 && t2.on("raphael.drag.end." + this.id, n3), t2("raphael.drag.start." + this.id, s2 || a2 || this, this._drag.x, this._drag.y, h3);
            }
            return this._drag = {}, Gt.push({
              el: this,
              start: h2
            }), this.mousedown(h2), this;
          }, Wt.onDragOver = function(e3) {
            e3 ? t2.on("raphael.drag.over." + this.id, e3) : t2.unbind("raphael.drag.over." + this.id);
          }, Wt.undrag = function() {
            for (var r3 = Gt.length; r3--; ) Gt[r3].el == this && (this.unmousedown(Gt[r3].start), Gt.splice(r3, 1), t2.unbind("raphael.drag.*." + this.id));
          ...
          i2.getElementByPoint = function(t3, e3) {
            ...
            if (l.win.opera && "svg" == c2.tagName) {
              var f2 = (i3 = (r3 = u2).getBoundingClientRect(), n3 = r3.ownerDocument, a2 = n3.body, s2 = n3.documentElement, o2 = s2.clientTop || a2.clientTop || 0, h2 = s2.clientLeft || a2.clientLeft || 0, {
                y: i3.top + (l.win.pageYOffset || s2.scrollTop || a2.scrollTop) - o2,
                x: i3.left + (l.win.pageXOffset || s2.scrollLeft || a2.scrollLeft) - h2
              }), p2 = u2.createSVGRect();
            ...
            if (!c2) return null;
            for (; c2.parentNode && c2 != u2.parentNode && !c2.raphael; ) c2 = c2.parentNode;
            ...
            for (var r3 = this.bottom; r3; ) {
              if (false === t3.call(e3, r3)) return this;
              r3 = r3.next;
            }
            return this;
            ...
            var e3 = {
              width: ((t3 = t3 || {}).width || 10) + (+this.attr("stroke-width") || 1),
              fill: t3.fill || false,
              opacity: null == t3.opacity ? 0.5 : t3.opacity,
              offsetx: t3.offsetx || 0,
              offsety: t3.offsety || 0,
              color: t3.color || "#000"
            }, r3 = e3.width / 2, i3 = this.paper, n3 = i3.set(), a2 = this.realPath || Z[this.type](this);
          ...
          var Xt = function(t3, r3, i3, n3, a2, s2, o2, l2, h2) {
            return null == h2 ? dt(t3, r3, i3, n3, a2, s2, o2, l2) : e2.findDotsAtSegment(t3, r3, i3, n3, a2, s2, o2, l2, function(t4, e3, r4, i4, n4, a3, s3, o3, l3) {
              if (!(l3 < 0 || dt(t4, e3, r4, i4, n4, a3, s3, o3) < l3)) {
                ...
                for (h3 = dt(t4, e3, r4, i4, n4, a3, s3, o3, c2); B(h3 - l3) > 0.01; ) h3 = dt(t4, e3, r4, i4, n4, a3, s3, o3, c2 += (h3 < l3 ? 1 : -1) * (u2 /= 2));
                return c2;
              }
            ...
            return function(i3, n3, a2) {
              for (var s2, o2, l2, h2, u2, c2 = "", f2 = {}, p2 = 0, d2 = 0, g2 = (i3 = Tt(i3)).length; d2 < g2; d2++) {
                if ("M" == (l2 = i3[d2])[0]) s2 = +l2[1], o2 = +l2[2];
                else {
                  if (p2 + (h2 = Xt(s2, o2, l2[1], l2[2], l2[3], l2[4], l2[5], l2[6])) > n3) {
                    if (r3 && !f2.start) {
                      if (c2 += ["C" + (u2 = Xt(s2, o2, l2[1], l2[2], l2[3], l2[4], l2[5], l2[6], n3 - p2)).start.x, u2.start.y, u2.m.x, u2.m.y, u2.x, u2.y], a2) return c2;
                      f2.start = c2, c2 = ["M" + u2.x, u2.y + "C" + u2.n.x, u2.n.y, u2.end.x, u2.end.y, l2[5], l2[6]].join(), p2 += h2, s2 = +l2[5], o2 = +l2[6];
                      continue;
                    }
                    if (!t3 && !r3) return {
                      x: (u2 = Xt(s2, o2, l2[1], l2[2], l2[3], l2[4], l2[5], l2[6], n3 - p2)).x,
                      y: u2.y,
                      alpha: u2.alpha
                    };
                  }
              ...
              return f2.end = c2, (u2 = t3 ? p2 : r3 ? f2 : e2.findDotsAtSegment(s2, o2, l2[0], l2[1], l2[2], l2[3], l2[4], l2[5], 1)).alpha && (u2 = {
                x: u2.x,
                y: u2.y,
                alpha: u2.alpha
              }), u2;
          ...
          e2.getTotalLength = $t, e2.getPointAtLength = Zt, e2.getSubpath = function(t3, e3, r3) {
            if (this.getTotalLength(t3) - r3 < 1e-6) return Qt(t3, e3).end;
            var i3 = Qt(t3, r3, 1);
            return e3 ? Qt(i3, e3).end : i3;
          }, Wt.getTotalLength = function() {
            var t3 = this.getPath();
            if (t3) return this.node.getTotalLength ? this.node.getTotalLength() : $t(t3);
          }, Wt.getPointAtLength = function(t3) {
            var e3 = this.getPath();
            if (e3) return Zt(e3, t3);
          }, Wt.getPath = function() {
          ...
          var Kt = [], te = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function(t3) {
            ...
            for (var r3 = +/* @__PURE__ */ new Date(), i3 = 0; i3 < Kt.length; i3++) {
              var n3 = Kt[i3];
              if (!n3.el.removed && !n3.paused) {
                ...
                if (n3.initstatus ? (l2 = (n3.initstatus * n3.anim.top - n3.prev) / (n3.percent - n3.prev) * h2, n3.status = n3.initstatus, delete n3.initstatus, n3.stop && Kt.splice(i3--, 1)) : n3.status = (n3.prev + (n3.percent - n3.prev) * (l2 / h2)) / n3.anim.top, !(l2 < 0)) if (l2 < h2) {
                  var m2 = u2(l2 / h2);
                  for (var b2 in c2) if (c2[o](b2)) {
                    switch (I[b2]) {
                      case T:
                      ...
                      case "path":
                        ...
                        for (var _2 = 0, w2 = c2[b2].length; _2 < w2; _2++) {
                          a2[_2] = [c2[b2][_2][0]];
                          for (var k2 = 1, B2 = c2[b2][_2].length; k2 < B2; k2++) a2[_2][k2] = +c2[b2][_2][k2] + m2 * h2 * p2[b2][_2][k2];
                          a2[_2] = a2[_2].join(g);
                        }
                        a2 = a2.join(g);
                        break;
                      case "transform":
                        if (p2[b2].real) for (a2 = [], _2 = 0, w2 = c2[b2].length; _2 < w2; _2++) for (a2[_2] = [c2[b2][_2][0]], k2 = 1, B2 = c2[b2][_2].length; k2 < B2; k2++) a2[_2][k2] = c2[b2][_2][k2] + m2 * h2 * p2[b2][_2][k2];
                        else {
                          var C2 = function(t3) {
                        ...
                        break;
                      case "csv":
                        if ("clip-rect" == b2) for (a2 = [], _2 = 4; _2--; ) a2[_2] = +c2[b2][_2] + m2 * h2 * p2[b2][_2];
                        break;
                      default:
                        var S2 = [][f](c2[b2]);
                        for (a2 = [], _2 = x2.paper.customAttributes[b2].length; _2--; ) a2[_2] = +S2[_2] + m2 * h2 * p2[b2][_2];
                    }
                    v2[b2] = a2;
                  }
                  ...
                  if (function(r4, i4, n4) {
                    ...
                    for (s2 in d2) d2[o](s2) && (y2[s2] = n3.totalOrigin[s2]);
            ...
            return function(t4, e4) {
              var r4 = function(t5, e5) {
                ...
                for (n4 = t5, u3 = 0; u3 < 8; u3++) {
                  if (a3 = f2(n4) - t5, B(a3) < e5) return n4;
                  if (B(h3 = (3 * l2 * n4 + 2 * o2) * n4 + s2) < 1e-6) break;
                  n4 -= a3 / h3;
                }
                if (i4 = 1, (n4 = t5) < (r5 = 0)) return r5;
                if (n4 > i4) return i4;
                for (; r5 < i4; ) {
                  if (a3 = f2(n4), B(a3 - t5) < e5) return n4;
          ...
          function ne(t3, e3) {
            ...
            if (this.ms = e3, this.times = 1, t3) {
              for (var n3 in t3) t3[o](n3) && (i3[z(n3)] = t3[n3], r3.push(z(n3)));
              r3.sort(H);
            }
          ...
          function ae(r3, i3, a2, s2, l2, h2) {
            ...
            if (s2) for (B2 = 0, C2 = Kt.length; B2 < C2; B2++) {
              var k2 = Kt[B2];
            ...
            if (u2) {
              if (c2) c2.initstatus = s2, c2.start = /* @__PURE__ */ new Date() - c2.ms * s2;
              else {
                for (var S2 in u2) if (u2[o](S2) && (I[o](S2) || i3.paper.customAttributes[o](S2))) switch (b2[S2] = i3.attr(S2), null == b2[S2] && (b2[S2] = j[S2]), _2[S2] = u2[S2], I[S2]) {
                  case T:
                  ...
                  case "path":
                    ...
                    for (b2[S2] = M2[0], w2[S2] = [], B2 = 0, C2 = b2[S2].length; B2 < C2; B2++) {
                      w2[S2][B2] = [0];
                      for (var N2 = 1, P2 = b2[S2][B2].length; N2 < P2; N2++) w2[S2][B2][N2] = (E2[B2][N2] - b2[S2][B2][N2]) / m2;
                    }
                    break;
                  case "transform":
                    var F2 = i3._, R2 = Lt(F2[S2], _2[S2]);
                    if (R2) for (b2[S2] = R2.from, _2[S2] = R2.to, w2[S2] = [], w2[S2].real = true, B2 = 0, C2 = b2[S2].length; B2 < C2; B2++) for (w2[S2][B2] = [b2[S2][B2][0]], N2 = 1, P2 = b2[S2][B2].length; N2 < P2; N2++) w2[S2][B2][N2] = (_2[S2][B2][N2] - b2[S2][B2][N2]) / m2;
                    else {
                      var D2 = i3.matrix || new Pt(), q2 = {
                        _: {
                  ...
                  case "csv":
                    ...
                    if ("clip-rect" == S2) for (b2[S2] = V2, w2[S2] = [], B2 = V2.length; B2--; ) w2[S2][B2] = (O2[B2] - b2[S2][B2]) / m2;
                    _2[S2] = O2;
                    break;
                  default:
                    for (O2 = [][f](u2[S2]), V2 = [][f](b2[S2]), w2[S2] = [], B2 = i3.paper.customAttributes[S2].length; B2--; ) w2[S2][B2] = ((O2[B2] || 0) - (V2[B2] || 0)) / m2;
                }
                var W2 = u2.easing, Y2 = e2.easing_formulas[W2];
                if (!Y2) if ((Y2 = x(W2).match(L)) && 5 == Y2.length) {
                  var G2 = Y2;
                  Y2 = function(t3) {
                ...
                if (k2 = {
                  anim: r3,
                  percent: a2,
                  timestamp: y2 = u2.start || r3.start || +/* @__PURE__ */ new Date(),
                  start: y2 + (r3.del || 0),
                  status: 0,
                  initstatus: s2 || 0,
                  stop: false,
                  ...
                  to: _2,
                  el: i3,
                  callback: u2.callback,
                  prev: g2,
                  next: d2,
                  repeat: h2 || r3.times,
                  origin: i3.attr(),
                  totalOrigin: l2
                }, Kt.push(k2), s2 && !c2 && !p2 && (k2.stop = true, k2.start = /* @__PURE__ */ new Date() - m2 * s2, 1 == Kt.length)) return ee();
                p2 && (k2.start = /* @__PURE__ */ new Date() - k2.ms * s2), 1 == Kt.length && te(ee);
              }
              t2("raphael.anim.start." + i3.id, i3, r3);
            }
          }
          function se(t3) {
            for (var e3 = 0; e3 < Kt.length; e3++) Kt[e3].el.paper == t3 && Kt.splice(e3--, 1);
          }
          Wt.animateWith = function(t3, r3, i3, n3, a2, s2) {
            if (this.removed) return s2 && s2.call(this), this;
            var o2 = i3 instanceof ne ? i3 : e2.animation(i3, n3, a2, s2);
            ae(o2, this, o2.percents[0], null, this.attr());
            for (var l2 = 0, h2 = Kt.length; l2 < h2; l2++) if (Kt[l2].anim == r3 && Kt[l2].el == t3) {
            ...
            if (t3 instanceof ne) return t3;
            !e2.is(i3, "function") && i3 || (n3 = n3 || i3 || null, i3 = null), t3 = Object(t3), r3 = +r3 || 0;
            var a2, s2, l2 = {};
            for (s2 in t3) t3[o](s2) && z(s2) != s2 && z(s2) + "%" != s2 && (a2 = true, l2[s2] = t3[s2]);
            if (a2) return i3 && (l2.easing = i3), n3 && (l2.callback = n3), new ne({
              100: l2
            }, r3);
            if (n3) {
              var h2 = 0;
            ...
            if (this.removed) return n3 && n3.call(this), this;
            ...
            var r3, i3, n3 = [], a2 = 0;
            if (null != e3) return ae(t3, this, -1, k(e3, 1)), this;
            for (r3 = Kt.length; a2 < r3; a2++) if ((i3 = Kt[a2]).el.id == this.id && (!t3 || i3.anim == t3)) {
              if (t3) return i3.status;
              n3.push({
                anim: i3.anim,
                status: i3.status
              });
            ...
            for (var r3 = 0; r3 < Kt.length; r3++) Kt[r3].el.id != this.id || e3 && Kt[r3].anim != e3 || false !== t2("raphael.anim.pause." + this.id, this, Kt[r3].anim) && (Kt[r3].paused = true);
            return this;
          }, Wt.resume = function(e3) {
            for (var r3 = 0; r3 < Kt.length; r3++) if (Kt[r3].el.id == this.id && (!e3 || Kt[r3].anim == e3)) {
              var i3 = Kt[r3];
              false !== t2("raphael.anim.resume." + this.id, this, i3.anim) && (delete i3.paused, this.status(i3.anim, i3.status));
            }
            return this;
          }, Wt.stop = function(e3) {
            for (var r3 = 0; r3 < Kt.length; r3++) Kt[r3].el.id != this.id || e3 && Kt[r3].anim != e3 || false !== t2("raphael.anim.stop." + this.id, this, Kt[r3].anim) && Kt.splice(r3--, 1);
            return this;
          }, t2.on("raphael.remove", se), t2.on("raphael.clear", se), Wt.toString = function() {
            return "Raphaël’s object";
          };
          var oe, le, he, ue, ce = function(t3) {
            if (this.items = [], this.length = 0, this.type = "set", t3) for (var e3 = 0, r3 = t3.length; e3 < r3; e3++) !t3[e3] || t3[e3].constructor != Wt.constructor && t3[e3].constructor != ce || (this[this.items.length] = this.items[this.items.length] = t3[e3], this.length++);
          }, fe = ce.prototype;
          for (var pe in fe.push = function() {
            for (var t3, e3, r3 = 0, i3 = arguments.length; r3 < i3; r3++) !(t3 = arguments[r3]) || t3.constructor != Wt.constructor && t3.constructor != ce || (this[e3 = this.items.length] = this.items[e3] = t3, this.length++);
            return this;
          }, fe.pop = function() {
            return this.length && delete this[this.length--], this.items.pop();
          }, fe.forEach = function(t3, e3) {
            for (var r3 = 0, i3 = this.items.length; r3 < i3; r3++) if (false === t3.call(e3, this.items[r3], r3)) return this;
            return this;
          }, Wt) Wt[o](pe) && (fe[pe] = /* @__PURE__ */ function(t3) {
            return function() {
              var e3 = arguments;
          ...
          return fe.attr = function(t3, r3) {
            if (t3 && e2.is(t3, A) && e2.is(t3[0], "object")) for (var i3 = 0, n3 = t3.length; i3 < n3; i3++) this.items[i3].attr(t3[i3]);
            ...
            var i3, n3 = [], a2 = [], s2 = [];
            for (i3 = 2; i3 < arguments.length; i3++) s2.push(arguments[i3]);
            for (i3 = 0; i3 < e3; i3++) a2.push(this[t3 + i3]);
            for (; i3 < this.length - t3; i3++) n3.push(this[t3 + i3]);
            var o2 = s2.length;
            for (i3 = 0; i3 < o2 + n3.length; i3++) this.items[t3 + i3] = this[t3 + i3] = i3 < o2 ? s2[i3] : n3[i3 - o2];
            for (i3 = this.items.length = this.length -= e3 - o2; this[i3]; ) delete this[i3++];
            return new ce(a2);
            ...
            for (a2 = this.items[--l2].animate(u2); l2--; ) this.items[l2] && !this.items[l2].removed && this.items[l2].animateWith(a2, u2, u2), this.items[l2] && !this.items[l2].removed || o2--;
            return this;
            ...
            for (var i3 in t3.face) t3.face[o](i3) && (e3.face[i3] = t3.face[i3]);
            if (this.fonts[r3] ? this.fonts[r3].push(e3) : this.fonts[r3] = [e3], !t3.svg) {
              for (var n3 in e3.face["units-per-em"] = F(t3.face["units-per-em"], 10), t3.glyphs) if (t3.glyphs[o](n3)) {
                var a2 = t3.glyphs[n3];
                if (e3.glyphs[n3] = {
                  w: a2.w,
                  k: {},
                ...
                }, a2.k) for (var s2 in a2.k) a2[o](s2) && (e3.glyphs[n3].k[s2] = a2.k[s2]);
              }
            }
            return t3;
            ...
            if (n3 = n3 || "normal", i3 = i3 || "normal", r3 = +r3 || {
              ...
              if (!s2) {
                ...
                for (var h2 in e2.fonts) if (e2.fonts[o](h2) && l2.test(h2)) {
                  s2 = e2.fonts[h2];
                  break;
                }
              }
              if (s2) for (var u2 = 0, c2 = s2.length; u2 < c2 && ((a2 = s2[u2]).face["font-weight"] != r3 || a2.face["font-style"] != i3 && a2.face["font-style"] || a2.face["font-stretch"] != n3); u2++) ;
              return a2;
            }
            ...
            return this.path(g2).attr({
              fill: "#000",
              stroke: "none"
            });
          }, i2.add = function(t3) {
            if (e2.is(t3, "array")) for (var r3, i3 = this.set(), n3 = 0, s2 = t3.length; n3 < s2; n3++) r3 = t3[n3] || {}, a[o](r3.type) && i3.push(this[r3.type]().attr(r3));
            return i3;
        ...
        s = "hasOwnProperty", o = /[\.\/]/, l = /\s*,\s*/, h = function(t2, e2) {
          ...
          for (var t2 = 0, e2 = this.length; t2 < e2; t2++) if (void 0 !== this[t2]) return this[t2];
        }, f = function() {
          for (var t2 = this.length; --t2; ) if (void 0 !== this[t2]) return this[t2];
          ...
          for (var v = 0, y = o2.length; v < y; v++) "zIndex" in o2[v] && (u2.push(o2[v].zIndex), o2[v].zIndex < 0 && (p2[o2[v].zIndex] = o2[v]));
          for (u2.sort(h); u2[l2] < 0; ) if (r2 = p2[u2[l2++]], d2.push(r2.apply(e2, s2)), a) return a = i2, d2;
          for (v = 0; v < y; v++) if ("zIndex" in (r2 = o2[v])) {
            if (r2.zIndex == u2[l2]) {
              if (d2.push(r2.apply(e2, s2)), a) break;
              do {
                if ((r2 = p2[u2[++l2]]) && d2.push(r2.apply(e2, s2)), a) break;
              } while (r2);
            } else p2[r2.zIndex] = r2;
          } else if (d2.push(r2.apply(e2, s2)), a) break;
          return a = i2, n = g2, d2;
          ...
          for (n2 = 0, a2 = c2.length; n2 < a2; n2++) {
            for (h2 = [], s2 = 0, l2 = p2.length; s2 < l2; s2++) for (r2 = [(f2 = p2[s2].n)[c2[n2]], f2["*"]], i2 = 2; i2--; ) (e2 = r2[i2]) && (h2.push(e2), d2 = d2.concat(e2.f || []));
            p2 = h2;
          }
          return d2;
          ...
          for (var r2 = g(t2) ? g(t2[0]) ? t2 : [t2] : d(t2).split(l), i2 = 0, n2 = r2.length; i2 < n2; i2++) !function(t3) {
            for (var r3, i3 = g(t3) ? t3 : d(t3).split(o), n3 = u, a2 = 0, s2 = i3.length; a2 < s2; a2++) n3 = (n3 = n3.n).hasOwnProperty(i3[a2]) && n3[i3[a2]] || (n3[i3[a2]] = {
              n: {}
            });
            for (n3.f = n3.f || [], a2 = 0, s2 = n3.f.length; a2 < s2; a2++) if (n3.f[a2] == e2) {
              r3 = true;
              break;
            }
            !r3 && n3.f.push(e2);
          ...
          if (t2) {
            ...
            if (r2.length > 1) for (var i2 = 0, n2 = r2.length; i2 < n2; i2++) x.off(r2[i2], e2);
            else {
              r2 = g(t2) ? t2 : d(t2).split(o);
              var a2, h2, c2, f2, p2, v = [u];
              for (i2 = 0, n2 = r2.length; i2 < n2; i2++) for (f2 = 0; f2 < v.length; f2 += c2.length - 2) {
                if (c2 = [f2, 1], a2 = v[f2].n, "*" != r2[i2]) a2[r2[i2]] && c2.push(a2[r2[i2]]);
                else for (h2 in a2) a2[s](h2) && c2.push(a2[h2]);
                v.splice.apply(v, c2);
              }
              for (i2 = 0, n2 = v.length; i2 < n2; i2++) for (a2 = v[i2]; a2.n; ) {
                if (e2) {
                  if (a2.f) {
                    for (f2 = 0, p2 = a2.f.length; f2 < p2; f2++) if (a2.f[f2] == e2) {
                      a2.f.splice(f2, 1);
                      break;
                    }
                    !a2.f.length && delete a2.f;
                  }
                  for (h2 in a2.n) if (a2.n[s](h2) && a2.n[h2].f) {
                    var y = a2.n[h2].f;
                    for (f2 = 0, p2 = y.length; f2 < p2; f2++) if (y[f2] == e2) {
                      y.splice(f2, 1);
                      break;
                    }
                    !y.length && delete a2.n[h2].f;
                  }
                } else for (h2 in delete a2.f, a2.n) a2.n[s](h2) && a2.n[h2].f && delete a2.n[h2].f;
                a2 = a2.n;
              }
            }
          } else x._events = u = {
        ...
        i = [r(0)], void 0 === (n = function(t2) {
          if (!t2 || t2.svg) {
            ...
            var x = function(i3, n3) {
              if (n3) for (var a2 in "string" == typeof i3 && (i3 = x(i3)), n3) n3[e2](a2) && ("xlink:" == a2.substring(0, 6) ? i3.setAttributeNS(p, a2.substring(6), r2(n3[a2])) : i3.setAttribute(a2, r2(n3[a2])));
              else (i3 = t2._g.doc.createElementNS("http://www.w3.org/2000/svg", i3)).style && (i3.style.webkitTapHighlightColor = "rgba(0,0,0,0)");
              return i3;
            }, v = function(e3, n3) {
              ...
              if (!m2) {
                ...
                if (u2 = u2.replace(/[\(\)\s,\xb0#]/g, "_"), e3.gradient && u2 != e3.gradient.id && (g2.defs.removeChild(e3.gradient), delete e3.gradient), !e3.gradient) {
                  ...
                  }), g2.defs.appendChild(m2);
                  for (var B2 = 0, C2 = k2.length; B2 < C2; B2++) m2.appendChild(x("stop", {
              ...
              if ((e3 = document.documentMode) && (9 === e3 || 10 === e3)) return "url('#" + t3 + "')";
              ...
              if ("path" == i3.type) {
                for (var s2, o2, l2, h2, u2, f2 = r2(n3).toLowerCase().split("-"), p2 = i3.paper, v2 = a2 ? "end" : "start", y2 = i3.node, m2 = i3.attrs, b2 = m2["stroke-width"], _2 = f2.length, w2 = "classic", k2 = 3, B2 = 3, C2 = 5; _2--; ) switch (f2[_2]) {
                  case "block":
                  case "classic":
                  case "oval":
                  case "diamond":
                ...
                if ("open" == w2 ? (k2 += 2, B2 += 2, C2 += 2, l2 = 1, h2 = a2 ? 4 : 1, u2 = {
                  fill: "none",
                  stroke: m2.stroke
                }) : (h2 = l2 = k2 / 2, u2 = {
                  fill: m2.stroke,
                  stroke: "none"
                }), i3._.arrows ? a2 ? (i3._.arrows.endPath && g[i3._.arrows.endPath]--, i3._.arrows.endMarker && g[i3._.arrows.endMarker]--) : (i3._.arrows.startPath && g[i3._.arrows.startPath]--, i3._.arrows.startMarker && g[i3._.arrows.startMarker]--) : i3._.arrows = {}, "none" != w2) {
                  var S2 = "raphael-marker-" + w2, T2 = "raphael-marker-" + v2 + w2 + k2 + B2 + "-obj" + i3.id;
                  t2._g.doc.getElementById(S2) ? g[S2]++ : (p2.defs.appendChild(x(x("path"), {
                    "stroke-linecap": "round",
                    d: d[w2],
                    id: S2
                  })), g[S2] = 1);
                  var A2, M2 = t2._g.doc.getElementById(T2);
                  M2 ? (g[T2]++, A2 = M2.getElementsByTagName("use")[0]) : (M2 = x(x("marker"), {
                    id: T2,
                    markerHeight: B2,
                    markerWidth: k2,
                    orient: "auto",
                  ...
                  }), M2.appendChild(A2), p2.defs.appendChild(M2), g[T2] = 1), x(A2, u2);
                ...
                } else a2 ? (s2 = i3._.arrows.startdx * b2 || 0, o2 = t2.getTotalLength(m2.path) - s2) : (s2 = 0, o2 = t2.getTotalLength(m2.path) - (i3._.arrows.enddx * b2 || 0)), i3._.arrows[v2 + "Path"] && x(y2, {
                  d: t2.getSubpath(m2.path, s2, o2)
                }), delete i3._.arrows[v2 + "Path"], delete i3._.arrows[v2 + "Marker"], delete i3._.arrows[v2 + "dx"], delete i3._.arrows[v2 + "Type"], delete i3._.arrows[v2 + "String"];
                for (u2 in g) if (g[e2](u2) && !g[u2]) {
              ...
              for (var d2 in l2.style.visibility = "hidden", a2) if (a2[e2](d2)) {
                ...
                switch (u2[d2] = g2, d2) {
                  ...
                  case "clip-rect":
                    ...
                    if (!g2) {
                      ...
                      if (M2) {
                        ...
                        E && E.parentNode.removeChild(E), x(l2, {
                          "clip-path": c
                        }), delete i3.clip;
                      }
                    }
                  ...
                  case "path":
                    ...
                    }), i3._.dirty = 1, i3._.arrows && ("startString" in i3._.arrows && b(i3, i3._.arrows.startString), "endString" in i3._.arrows && b(i3, i3._.arrows.endString, 1)));
                    break;
                  case "width":
                  ...
                  case "stroke":
                    P = t2.getRGB(g2), l2.setAttribute(d2, P.hex), "stroke" == d2 && P[e2]("opacity") && x(l2, {
                      "stroke-opacity": P.opacity > 1 ? P.opacity / 100 : P.opacity
                    }), "stroke" == d2 && i3._.arrows && ("startString" in i3._.arrows && b(i3, i3._.arrows.startString), "endString" in i3._.arrows && b(i3, i3._.arrows.endString, 1));
                    break;
                  case "gradient":
                  ...
                  case "fill-opacity":
                    if (u2.gradient) {
                      (z = t2._g.doc.getElementById(l2.getAttribute("fill").replace(/^url\(#|\)$/g, c))) && (F = z.getElementsByTagName("stop"), x(F[F.length - 1], {
                        "stop-opacity": g2
                      }));
                      break;
                    }
              ...
              if ("text" == i3.type && (a2[e2]("text") || a2[e2]("font") || a2[e2]("font-size") || a2[e2]("x") || a2[e2]("y"))) {
                ...
                if (a2[e2]("text")) {
                  ...
                  for (var h2, u2 = r2(a2.text).split("\n"), f2 = [], p2 = 0, d2 = u2.length; p2 < d2; p2++) h2 = x("tspan"), p2 && x(h2, {
                    dy: 1.2 * l2,
                    x: s2.x
                  }), h2.appendChild(t2._g.doc.createTextNode(u2[p2])), o2.appendChild(h2), f2[p2] = h2;
                } else for (p2 = 0, d2 = (f2 = o2.getElementsByTagName("tspan")).length; p2 < d2; p2++) p2 ? x(f2[p2], {
                  dy: 1.2 * l2,
                  x: s2.x
                }) : x(f2[0], {
                  dy: 0
              ...
              this[0] = this.node = e3, e3.raphael = true, this.id = ("0000" + (Math.random() * Math.pow(36, 5) << 0).toString(36)).slice(-5), e3.raphaelid = this.id, this.matrix = t2.matrix(), this.realPath = null, this.paper = r3, this.attrs = this.attrs || {}, this._ = {
                transform: [],
                sx: 1,
                sy: 1,
                deg: 0,
            ...
            S.prototype = T, T.constructor = S, t2._engine.path = function(t3, e3) {
              ...
              if (this.removed) return this;
              if ((t3 = r2(t3).split(h)).length - 1 && (e3 = i2(t3[1]), n3 = i2(t3[2]), a2 = i2(t3[3])), t3 = i2(t3[0]), null == e3 && (e3 = t3), null == a2 && (n3 = a2), null == n3 || null == a2) var s2 = this.getBBox(1);
              ...
              if (!this.removed && e3.parentNode) {
                var r3 = this.paper;
                for (var i3 in r3.__set__ && r3.__set__.exclude(this), u.unbind("raphael.*.*." + this.id), this.gradient && r3.defs.removeChild(this.gradient), t2._tear(this, r3), e3.parentNode.removeChild(e3), this.removeData(), this) this[i3] = "function" == typeof this[i3] ? t2._removedFactory(i3) : null;
                this.removed = true;
              }
            }, T._getBBox = function() {
              ...
              if (null == i3 && t2.is(r3, "string")) {
                ...
                for (var s2 = r3.split(h), o2 = {}, l2 = 0, c2 = s2.length; l2 < c2; l2++) (r3 = s2[l2]) in this.attrs ? o2[r3] = this.attrs[r3] : t2.is(this.paper.customAttributes[r3], "function") ? o2[r3] = this.paper.customAttributes[r3].def : o2[r3] = t2._availableAttrs[r3];
              ...
              for (p2 in this.paper.customAttributes) if (this.paper.customAttributes[e2](p2) && f2[e2](p2) && t2.is(this.paper.customAttributes[p2], "function")) {
                ...
                for (var g2 in this.attrs[p2] = f2[p2], d2) d2[e2](g2) && (f2[g2] = d2[g2]);
              }
              ...
              return n3 = n3 || 0, a2 = a2 || 0, x(l2, {
                height: o2 = o2 || 342,
                version: 1.1,
                width: s2 = s2 || 512,
                xmlns: "http://www.w3.org/2000/svg",
                "xmlns:xlink": "http://www.w3.org/1999/xlink"
              }), 1 == r3 ? (l2.style.cssText = h2 + "position:absolute;left:" + n3 + "px;top:" + a2 + "px", t2._g.doc.body.appendChild(l2), i3 = 1) : (l2.style.cssText = h2 + "position:relative", r3.firstChild ? r3.insertBefore(l2, r3.firstChild) : r3.appendChild(l2)), (r3 = new t2._Paper()).width = s2, r3.height = o2, r3.canvas = l2, r3.clear(), r3._left = r3._top = 0, i3 && (r3.renderfix = function() {
              }), r3.renderfix(), r3;
              ...
              for (null == t3 ? (this._vbSize && (h2 = 1), delete this._vbSize, a2 = "0 0 " + this.width + f + this.height) : (this._vbSize = h2, a2 = t3 + f + e3 + f + r3 + f + i3), x(this.canvas, {
                viewBox: a2,
                preserveAspectRatio: p2
              }); h2 && c2; ) o2 = "stroke-width" in c2.attrs ? c2.attrs["stroke-width"] : 1, c2.attr({
                "stroke-width": o2
              }), c2._.dirty = 1, c2._.dirtyT = 1, c2 = c2.prev;
              ...
              for (var e3 in u("raphael.remove", this), this.canvas.parentNode && this.canvas.parentNode.removeChild(this.canvas), this) this[e3] = "function" == typeof this[e3] ? t2._removedFactory(e3) : null;
            };
            var A = t2.st;
            for (var M in T) T[e2](M) && !A[e2](M) && (A[M] = /* @__PURE__ */ function(t3) {
              return function() {
                var e3 = arguments;
                return this.forEach(function(r3) {
                  r3[t3].apply(r3, e3);
        ...
        i = [r(0)], void 0 === (n = function(t2) {
          if (!t2 || t2.vml) {
            var e2 = "hasOwnProperty", r2 = String, i2 = parseFloat, n2 = Math, a = n2.round, s = n2.max, o = n2.min, l = n2.abs, h = /[, ]+/, u = t2.eve, c = " ", f = "", p = {
              M: "m",
              L: "l",
              C: "c",
              Z: "x",
              ...
              c: "v",
              z: "x"
            }, d = /([clmz]),?([^clmz]*)/gi, g = / progid:\S+Blur\([^\)]+\)/g, x = /-?[^,\s-]+/g, v = "position:absolute;left:0;top:0;width:1px;height:1px;behavior:url(#default#VML)", y = 21600, m = {
              path: 1,
              rect: 1,
              image: 1
            }, b = {
            ...
            var k, B = function(t3, e3, i3) {
              ...
              for (var A2 in l2) l2[e2](A2) && (g2[A2] = l2[A2]);
              if (_2 && (g2.path = t2._getPath[n3.type](n3), n3._.dirty = 1), l2.href && (u2.href = l2.href), l2.title && (u2.title = l2.title), l2.target && (u2.target = l2.target), l2.cursor && (v2.cursor = l2.cursor), "blur" in l2 && n3.blur(l2.blur), (l2.path && "path" == n3.type || _2) && (u2.path = function(e3) {
                ...
                for (var u3 = 0, g3 = h2.length; u3 < g3; u3++) {
                  ...
                  for (var v3 = 1, m2 = o2.length; v3 < m2; v3++) l3 += a(o2[v3] * y) + (v3 != m2 - 1 ? "," : f);
                  s2.push(l3);
                }
                return s2.join(c);
              ...
              if ("arrow-start" in l2 && B(T2, l2["arrow-start"]), "arrow-end" in l2 && B(T2, l2["arrow-end"], 1), null != l2.opacity || null != l2.fill || null != l2.src || null != l2.stroke || null != l2["stroke-width"] || null != l2["stroke-opacity"] || null != l2["fill-opacity"] || null != l2["stroke-dasharray"] || null != l2["stroke-miterlimit"] || null != l2["stroke-linejoin"] || null != l2["stroke-linecap"]) {
                ...
                if (!(j = j && j[0]) && (j = k("fill")), "image" == n3.type && l2.src && (j.src = l2.src), l2.fill && (j.on = true), null != j.on && "none" != l2.fill && null !== l2.fill || (j.on = false), j.on && l2.fill) {
                  ...
                  } else j.color = t2.getRGB(l2.fill).hex, j.src = f, j.type = "solid", t2.getRGB(l2.fill).error && (T2.type in {
                    circle: 1,
                    ellipse: 1
                  } || "r" != r2(l2.fill).charAt()) && S(T2, l2.fill, j) && (g2.fill = "none", g2.gradient = l2.fill, j.rotate = false);
                }
              ...
              if ("text" == T2.type) {
                ...
                for (var $ = ["x", "y", "text", "font", "font-family", "font-weight", "font-style", "font-size"], Z = 0, Q = $.length; Z < Q; Z++) if ($[Z] in l2) {
                  T2._.dirty = 1;
                  break;
                }
              ...
              if (e3.attrs.gradient = a2, a2 = (a2 = r2(a2).replace(t2._radial_gradient, function(t3, e4, r3) {
                ...
                var u2 = a2.shift();
                if (u2 = -i2(u2), isNaN(u2)) return null;
              }
              ...
              if (e3 = e3.shape || e3.node, p2.length) {
                ...
                for (var d2 = [], g2 = 0, x2 = p2.length; g2 < x2; g2++) p2[g2].offset && d2.push(p2[g2].offset + c + p2[g2].color);
            ...
            T.prototype = A, A.constructor = T, A.transform = function(e3) {
              ...
              if (o2.translate(1, 1), p2 || u2 || "image" == this.type) {
                ...
                } else h2.style.filter = f, w(this, s2.scalex, s2.scaley, s2.dx, s2.dy, s2.rotate);
              } else h2.style.filter = f, l2.matrix = r2(o2), l2.offset = o2.offset();
              ...
              if (this.removed) return this;
              if ((t3 = r2(t3).split(h)).length - 1 && (e3 = i2(t3[1]), n3 = i2(t3[2]), a2 = i2(t3[3]), isNaN(n3) && (n3 = null), isNaN(a2) && (a2 = null)), t3 = i2(t3[0]), null == e3 && (e3 = t3), null == a2 && (n3 = a2), null == n3 || null == a2) var s2 = this.getBBox(1);
              ...
              if (!this.removed && this.node.parentNode) {
                for (var e3 in this.paper.__set__ && this.paper.__set__.exclude(this), t2.eve.unbind("raphael.*.*." + this.id), t2._tear(this, this.paper), this.node.parentNode.removeChild(this.node), this.shape && this.shape.parentNode.removeChild(this.shape), this) this[e3] = "function" == typeof this[e3] ? t2._removedFactory(e3) : null;
                this.removed = true;
              }
              ...
              var f2;
              for (var p2 in null != i3 && ((f2 = {})[r3] = i3), null == i3 && t2.is(r3, "object") && (f2 = r3), f2) u("raphael.attr." + p2 + "." + this.id, this, f2[p2]);
              if (f2) {
                for (p2 in this.paper.customAttributes) if (this.paper.customAttributes[e2](p2) && f2[e2](p2) && t2.is(this.paper.customAttributes[p2], "function")) {
                  var d2 = this.paper.customAttributes[p2].apply(this, [].concat(f2[p2]));
                  for (var g2 in this.attrs[p2] = f2[p2], d2) d2[e2](g2) && (f2[g2] = d2[g2]);
              ...
              var a2 = t3.path();
              a2.attrs;
              return a2.X = e3 - i3, a2.Y = r3 - n3, a2.W = 2 * i3, a2.H = 2 * n3, a2.type = "ellipse", C(a2, {
                cx: e3,
                cy: r3,
                rx: i3,
                ry: n3
              ...
              var n3 = t3.path();
              n3.attrs;
              return n3.X = e3 - i3, n3.Y = r3 - i3, n3.W = n3.H = 2 * i3, n3.type = "circle", C(n3, {
                cx: e3,
                cy: r3,
                r: i3
              }), n3;
              ...
              var o2 = t2._rectPath(i3, n3, a2, s2), l2 = e3.path(o2).attr({
                stroke: "none"
              }), h2 = l2.attrs, u2 = l2.node, c2 = u2.getElementsByTagName("fill")[0];
              ...
              return a2 && (i3 * (s2 = u2 / n3) < h2 && (e3 -= (h2 - i3 * s2) / 2 / s2), n3 * (o2 = h2 / i3) < u2 && (r3 -= (u2 - n3 * o2) / 2 / o2)), this._viewBox = [e3, r3, i3, n3, !!a2], this._viewBoxShift = {
                dx: -e3,
                dy: -r3,
                scale: l2
              ...
              for (var e3 in t2.eve("raphael.remove", this), this.canvas.parentNode.removeChild(this.canvas), this) this[e3] = "function" == typeof this[e3] ? t2._removedFactory(e3) : null;
              return true;
            };
            var M = t2.st;
            for (var E in A) A[e2](E) && !M[e2](E) && (M[E] = /* @__PURE__ */ function(t3) {
              return function() {
                var e3 = arguments;
                return this.forEach(function(r3) {
                  r3[t3].apply(r3, e3);
...
//# sourceMappingURL=chunk-AUYSCLCO.js.map
